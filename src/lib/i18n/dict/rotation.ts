...
export const fr: Record<RotationKey, string> = {
  ...
  "rotation.description":
    "Classe tes joueuses : les 5 premières sont titulaires, la 6ème entre en premier du banc. Au-delà de la 8ème, une joueuse ne joue que si assez de titulaires/banc sortent (fautes, blessures).",
  ...
  "rotation.moveUp": "Monter",
  "rotation.moveDown": "Descendre",
...
export const en: Record<RotationKey, string> = {
  "rotation.title": "Rotation",
  "rotation.description":
    "Rank your players: the top 5 are starters, the 6th is first off the bench. Beyond 8th, a player only sees the floor if enough starters/bench players are out (fouls, injuries).",
  ...
  "rotation.moveUp": "Move up",
  "rotation.moveDown": "Move down",
