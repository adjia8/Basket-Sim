export const keys = [
  ...
  "dashboard.advanceCalendarTimedOut",
...
export const en: Record<DashboardKey, string> = {
  ...
  "dashboard.advanceCalendarTimedOut": "This is taking unusually long (likely a database connection hiccup) — try again shortly.",
