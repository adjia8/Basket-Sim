...
export const WNBA_REAL_PROSPECTS: Record<string, ProspectSeed[]> = {
  "2027": [
    ...
    { firstName: "Dominika", lastName: "Paurová", position: "SF", heightCm: 188, age: 20, overallRating: 74, scoutingNote: "Rutgers (NCAA) / Slovaquie" },
    { firstName: "Sania", lastName: "Feagin", position: "C", heightCm: 191, age: 21, overallRating: 76, scoutingNote: "South Carolina (NCAA)" },
    { firstName: "Kate", lastName: "Koval", position: "C", heightCm: 196, age: 20, overallRating: 74, scoutingNote: "Rutgers (NCAA) / Ukraine" },
  ],
  "2028": [
    ...
    { firstName: "Aicha", lastName: "Coulibaly", position: "SF", heightCm: 185, age: 19, overallRating: 72, scoutingNote: "Ohio State (NCAA) / Mali" },
